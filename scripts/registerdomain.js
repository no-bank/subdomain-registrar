...
module.exports = async function(callback) {
    ...
    console.log("crazy.one Available?" , await baseRegistrar.available(utils.sha3('resolver')))
    ...
    // 31536000
    try{
        var firstController = await ETHRegistrarController.at("0x82ee6596D7E30d384AF9F7A0552fCa55adD7A008");
        console.log("Available on controller=", await firstController.available("sefwallet"))
        ...
        //console.log(tx)
        var tx = await ens.setResolver(namehash.hash('sefwallet.one'), "0xf046697010509cc5BeB952eF4CeD1dE210a7977f", {from: accounts[0]});
